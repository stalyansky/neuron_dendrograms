...
#     ax.text(0.05, -0.1, textstr, transform=ax.transAxes, fontsize=4,
...
#     plt.close()
    ...
    ####compute_hierarchy: helper function run atuomatically during initializaion
    ...
    ####create_lines: helper function run automatically during initialization
